...
class _EditStatistikPageState extends State<EditStatistikPage> {
  ...
  void initState() {
    super.initState();
    // Initialize controllers dengan data dari statistik - SESUAI MODEL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit Statistik - ${widget.statistik.homeTeam} vs ${widget.statistik.awayTeam}'),
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Match: ${widget.statistik.homeTeam} vs ${widget.statistik.awayTeam}',
                        style: TextStyle(
                          fontSize: 18,
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Score: ${widget.statistik.homeScore} - ${widget.statistik.awayScore}',
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Stadium: ${widget.statistik.stadium}',
                        style: TextStyle(
                          fontSize: 14,
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Match Date: ${widget.statistik.matchDate}',
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey[600],
                        ),
